                        ...
                        <div className="form-group">
                            ...
                            <div className="input-with-button">
                                <input
                                    ...
                                    placeholder="C:\legacy\java16\src"
                        ...
                        <div className="form-group">
                            ...
                            <div className="input-with-button">
                                <input
                                    ...
                                    placeholder="C:\guides\java-modernization"
                                    className="form-input"
                                />
                                <button
                                    className="btn btn-browse"
                        ...
                        <div className="form-group">
                            ...
                            <div className="input-with-button">
                                <input
                                    ...
                                    placeholder="C:\modern\java21\src"
                                    className="form-input"
                                />
                                <button
                                    className="btn btn-browse"
                ...
                <div className="form-section">
                    ...
                    <div className="options-grid">
                        <label className="checkbox-label">
                            ...
                            <span>Stream API 변환</span>
                        </label>
                        <label className="checkbox-label">
                            <input type="checkbox" defaultChecked />
                            <span>Lambda 표현식 사용</span>
                        </label>
                        <label className="checkbox-label">
                            <input type="checkbox" defaultChecked />
                            <span>Record 클래스 생성</span>
                        </label>
                        <label className="checkbox-label">
                            <input type="checkbox" />
                            <span>Pattern Matching 적용</span>
                        </label>
                    </div>
                </div>
                ...
                {isConverting && (
                    <div className="progress-section">
                        ...
                        <div className="progress-stats">
                            <span>처리 중: UserService.java</span>
                            <span>15 / 150 파일</span>
                        </div>
                    </div>
                )}
